...
{
    public static void ChallengeLoops()
    {
                    ...
                    for (int i = 0; i < maxPets; i++)
                    {
                        ...
                        if (ourAnimals[i,2] == "Age: ?")
                        {
                            ...
                            do
                            {
                                ...
                                validValue = int.TryParse(inputValue, out value);
                            } while (!validValue);

                            ourAnimals[i, 2] = $"Age: {inputValue}";
                            ...
                            do
                            {
                                ...
                                if (string.IsNullOrEmpty(inputDesc)) continue;

                                ourAnimals[i, 3] = $"Physical description: {inputDesc}";
                                validDesc = true;
